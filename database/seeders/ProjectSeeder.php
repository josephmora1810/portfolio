...
class ProjectSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $project3 = Project::updateOrCreate(
            ['slug' => 'ubik.go'],
            [
                'title' => 'UbikGo (en desarrollo)',
                'short_description_es' => 'Plataforma de gestión de servicios de grúas con geolocalización en tiempo real y notificaciones.',
                'short_description_en' => 'Tow truck service management platform with real-time geolocation and notifications.',
                'content_es' => <<<TEXT
